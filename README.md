...
This repository contains a collection of debugging skills, derived from and based on Jesse Vincent's Superpowers workflow,
designed to be combined modularly with other skill sets. These skills are intended to be used together with the Core Skills
module.
